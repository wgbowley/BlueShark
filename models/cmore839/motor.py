...
Description:
    Model for cmore839 tubular linear motor design
...
class CmoreTubular(LinearBase):
    """
    Model for cmore839 tubular linear motor.
    ...
    def setup(self) -> None:
        ...
        try:
            ...
            # uncomment below for other materials & comment out AluminumTube
            # femm.mi_getmaterial(self.tube_material)
            femm.mi_addmaterial(
                'AluminumTube', 1, 1, 0, 0, 37, 0,
                0, 1, 0, 0, 0, 1, 1
            )
    ...
    def _add_armature(self) -> None:
        ...
        for slot in range(self.number_slots):
            ...
            if slot % 3 != 0:
                z += self.slot_axial_length + self.slot_axial_length
            else:
    ...
    def _compute_geometry(self) -> None:
        ...
        air_gaps = self.slot_axial_spacing * (1 + self.number_slots // 2)
